...
export const UiTextHeader: React.FC<UiTextHeaderProps> = ({
  ...
  return (
    <Tag
      className={`relative inline-flex max-w-full items-center justify-center gap-2 bg-center bg-no-repeat px-10 py-3 text-center font-serif font-bold uppercase tracking-wide text-[#3A2A18] ${className}`}
      style={{
